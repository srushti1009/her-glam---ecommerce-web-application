...
const Order = ({ orderFormValue, cartItems, selectedCurrency, clearCart }) => {
    ...
    useEffect(() => {
        document.title = "Order summary | HerGlam";
    }, []);
    ...
    return (
        <main className="order">
            ...
            <section className="order-success">
                ...
                <p>
                    Your order has been received successfully at HerGlam. We're thrilled that you've chosen us for your fashion needs. Your style journey is about to begin!
                </p>
                <h3> Order Details:</h3>
